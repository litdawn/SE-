...
INSERT INTO `customer` VALUES (2, '销售商', 1, 'lxs', '12580', '南哪儿大学', '123457', '12121@cba.com', 100000.00, 100000.00, 100000.00, 'uncln');
...
CREATE TABLE `staff_information`  (
  `staff_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '员工id',
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '姓名',
  `gender` char(2) comment 'm for male,f for female',check(gender in ('m','f')),
  `birth_day` varchar(255) NULL COMMENT 'YYYYMMDD',
  `phone_number` char(11),
  `role` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '岗位',
  `basic_amount` decimal(10, 2) NOT NULL COMMENT '基本工资',
  `position_amount` decimal(10,2) NOT NULL COMMENT '岗位工资',
  `level` int(7) default 1 comment '普通员工1,经理2,总经理3',check ( level in (1,2,3) ),
  `payment_calculation`  varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '分级扣税' COMMENT '计算方式',
  `payment_schedule`  varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '薪酬发放规则',
  `staff_bank_account` char(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '员工银行卡号',
  PRIMARY KEY (`staff_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for company_bank_account_sheet
-- ----------------------------
DROP TABLE IF EXISTS `company_bank_account_sheet`;
CREATE TABLE `company_bank_account_sheet`  (
  `id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'id',
  `company_bank_account_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '账户名称',
  `company_bank_account_money` decimal(10, 2) NULL DEFAULT NULL COMMENT '账户金额（该账户的余额）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for payable_sheet
-- ----------------------------
DROP TABLE IF EXISTS `payable_sheet`;
CREATE TABLE `payable_sheet`  (
  `id` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '付款单单据编号（格式为：XJFYD-yyyyMMdd-xxxxx',
  `bank_account` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '银行账户id',
...
-- ----------------------------
-- Table structure for receivable_sheet
-- ----------------------------
DROP TABLE IF EXISTS `receivable_sheet`;
CREATE TABLE `receivable_sheet`  (
...
-- Table structure for receivable_sheet
-- ----------------------------
DROP TABLE IF EXISTS `receivable_sheet_content`;
CREATE TABLE `receivable_sheet_content`  (
  `sheet_id` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '收款单id',
  `bank_account` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '银行账户id',
...
-- ----------------------------
-- Table structure for payable_sheet_content
-- ----------------------------
DROP TABLE IF EXISTS `payable_sheet_content`;
CREATE TABLE `payable_sheet_content`  (
  `sheet_id` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '付customer款单id',
  `name` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '条目名',
...
CREATE TABLE `sale_returns_sheet`  (
  ...
  `voucher_amount` decimal(10, 2) NULL DEFAULT NULL COMMENT '代金券总额',
  `total_amount` decimal(10, 2) NULL DEFAULT NULL COMMENT '退货的最终总额合计',
  `state` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '单据状态',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `attendance_sheet`  (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '姓名',
  `role` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '岗位',
  `date` datetime(0) NULL DEFAULT NULL COMMENT '打卡日期',
  PRIMARY KEY (`staff_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for gift_sheet
-- ----------------------------
DROP TABLE IF EXISTS `gift_sheet`;
CREATE TABLE `gift_sheet`  (
  `id` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'KCZSD + date + index = 库存赠送单id',
  `sale_sheet_id` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '对应的销售单id',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `product_id` char(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '赠品商品编号',
...
CREATE TABLE `promotion`  (
  `id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '策略id',
  `kind` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '代金券，赠品，折扣',
  `rule` varchar(255) NOT NULL COMMENT '客户等级，总金额，商品组合',
  `level` int NULL COMMENT '>=此客户等级',
  `amount` decimal(10, 2)  NULL COMMENT '>=此总金额',
  `composition1_id` char(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '组合中第一个商品的id',
  `composition2_id` char(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '组合中第二个商品的id',
  `begin_date` datetime(0) COMMENT '生效起始日期',
  `end_date` datetime(0) COMMENT '生效截止日期',
  `discount` int COMMENT '80 for 8折',
  `voucher` decimal(10, 2)  NULL COMMENT '代金券金额/商品组合的降价金额',
  `gift_id` char(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '赠品商品编号',
  `gift_quantity` int COMMENT '赠品数量',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for salary_sheetstaff_information
-- ----------------------------
DROP TABLE IF EXISTS `salary_sheet`;
CREATE TABLE `salary_sheet`  (
  `id` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '工资单单据编号(格式为：GZD-yyyyMMdd-xxxxx)',
  `staff_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '员工id',
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '姓名',
  `role` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '岗位',
  `operator` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '操作员',
  `basic_amount` decimal(10, 2) NOT NULL COMMENT '基本工资',
  `position_amount` decimal(10,2) NOT NULL COMMENT '岗位工资',
  `absence_times` int(11) NOT NULL DEFAULT 0 COMMENT '缺勤次数',
  `annual_bonus` decimal(10, 2) NULL DEFAULT NULL COMMENT '年终奖',
  `raw_amount` decimal(10, 2) NOT NULL COMMENT '应发工资',
  `tax_amount` decimal(10, 2) NOT NULL COMMENT '税款',
  `push_money` double(3, 2) NOT NULL COMMENT '提成',
  `final_amount` decimal(10, 2) NOT NULL COMMENT '实发金额',
  `state` varchar(31) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '单据状态',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `staff_bank_account` char(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '员工银行卡号',
  `payment_schedule`  varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '薪酬发放规则',
...
-- ----------------------------
-- Table structure for annual_bonus
-- ----------------------------
DROP TABLE IF EXISTS `annual_bonus`;
CREATE TABLE `annual_bonus`  (
                                 `staff_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '员工id',
                                 `tax_amount` decimal(10, 2) NOT NULL COMMENT '年终奖'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;