...
public interface SaleSheetDao {
     ...
     * @return
     */
    List<SaleStatusSheetPO> findSheet(Date startTime, Date endTime, String pid, Integer supplier, String salesman);
     ...
     * @return
     */
    List<SaleSheetPO> findSaleSheet(Date startTime, Date endTime, Integer supplier, String salesman);

    int findProductQuantity(String sheetId,String pid);
}
