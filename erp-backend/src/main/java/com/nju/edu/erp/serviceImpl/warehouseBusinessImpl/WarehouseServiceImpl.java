package com.nju.edu.erp.serviceImpl.warehouseBusinessImpl;
...
//        warehouseDao.saveBatch(warehousePOList);
    ...
    public void productOutOfWarehouse(WarehouseOutputFormVO warehouseOutputFormVO) {
        ...
        toSave.setId(generateWarehouseOutputId(warehouseOutputSheetPO == null ? null : warehouseOutputSheetPO.getId()));//单号计算完成
...
//            warehouseDao.deductQuantity(warehousePO);
    ...
    public List<WarehouseIODetailPO> getWarehouseIODetailByTime(String beginDateStr, String endDateStr) {
        ...
        List<WarehouseIODetailPO> list =warehouseInputSheetDao.getWarehouseIODetailByTime(beginDate,endDate);
        if(list==null||list.size()==0) {
            List<WarehouseIODetailPO> li = new ArrayList<>();
            return li;
        }
        return list;
...
//        List<WarehouseCountingVO> all = warehouseCounting();
//        return all;
//    }
}
